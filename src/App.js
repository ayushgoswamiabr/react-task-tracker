...
function App() {
  ...
  const fetchtask = async (id) => {
    const res = await fetch(`${process.env.REACT_APP_BACKEND}/tasks/${id}`);
    const data = await res.json();
    return data;
  };
  ...
  const deleteTask = async (id) => {
    ...
    await fetch(`${process.env.REACT_APP_BACKEND}/tasks/${id}`, {
      method: "DELETE",
    });
  };
  ...
  const loginfun = async (cred) => {
    const res = await fetch(`${process.env.REACT_APP_BACKEND}/login/signin`, {
      method: "POST",
      headers: { "content-type": "application/json" },
  ...
  const signupfun = async (cred) => {
    const res = await fetch(`${process.env.REACT_APP_BACKEND}/login/signup`, {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify(cred),
    });
